  ...
  return (
    <Layout>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        >
          <span className="w-8 h-8 rounded-full bg-card border border-theme flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">←</span>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="card border-t-4 border-t-indigo-500">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-xs font-bold text-muted uppercase mb-3">Tentukan Status Akhir</label>
                <div className="grid grid-cols-3 gap-3">
                    <button 
                      onClick={() => setSubscribedChoice(true)} 
                      className={`contact-choice ${subscribedChoice === true ? "contact-choice-yes" : "border"}`}
                    >
                      <span className="text-lg block mb-1">🤝</span> Berlangganan
                    </button>

                    <button 
                      onClick={() => setSubscribedChoice(false)} 
                      className={`contact-choice ${subscribedChoice === false ? "contact-choice-no" : "border"}`}
                    >
                      <span className="text-lg block mb-1">⛔</span> Menolak
                    </button>

                    <button 
                      onClick={() => setSubscribedChoice(null)} 
                      className={`contact-choice ${subscribedChoice === null ? "contact-choice-unk" : "border"}`}
                    >
                      <span className="text-lg block mb-1">⏳</span> Belum Jelas
                    </button>
                </div>
              </div>
